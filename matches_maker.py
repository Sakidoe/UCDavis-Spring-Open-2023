...
def get_bye_entries(size):
  if size == 4:
    ...
    return[2, 127, 4, 125, 6, 123, 8, 121, 10, 119, 12, 117, 14, 115, 16, 113, 18, 111, 20, 109, 22, 107, 24, 105, 26, 103, 28, 101, 30, 99, 32, 97, 34, 95, 36, 93, 38, 91, 40, 89,
          42, 87, 44, 85, 46, 83, 48, 81, 50, 79, 52, 77, 54, 75, 56, 73, 58, 71, 60, 69, 62, 67, 64]
