...
def main():
  ...
  sat_courts = [Court(1, Court.HIGH_QUALITY),
                ...
                Court(3, Court.HIGH_QUALITY),
                Court(4, Court.HIGH_QUALITY),
                Court(5, Court.HIGH_QUALITY),
                Court(6, Court.HIGH_QUALITY),
                Court(7, Court.HIGH_QUALITY, 180),
                Court(8, Court.HIGH_QUALITY, 180),
                Court(9, Court.HIGH_QUALITY, 180),
                Court(10, Court.HIGH_QUALITY, 180),
                Court(11, Court.MED_QUALITY, 180),
                Court(12, Court.MED_QUALITY, 180),
                Court(13, Court.MED_QUALITY, 180),
                Court(14, Court.MED_QUALITY, 180),
                Court(15, Court.LOW_QUALITY, 180),
                Court(16, Court.LOW_QUALITY, 180),
                Court(17, Court.LOW_QUALITY, 180),
                Court(17, Court.LOW_QUALITY, 180)#
                ]
